  ...
  return (
    ...
    >
      <main id="main-content" className="mx-auto max-w-6xl px-5 py-12 sm:px-8">
        <div className="sr-only" role="status" aria-live="polite">Loading trip details…</div>
        <div className="space-y-8 motion-safe:animate-pulse">
          {/* Breadcrumb Skeleton */}
          <div className="flex items-center gap-2 border-b border-surface-rule pb-4">
          ...
          <div className="grid gap-0 border-b border-surface-rule lg:grid-cols-[1.35fr_0.8fr_0.65fr]">
            <div className="py-9 lg:border-r lg:border-surface-rule lg:pr-10 space-y-3">
              <div className="h-4 w-24 rounded bg-rule/40" />
              <div className="h-12 w-48 rounded bg-rule/60" />
            </div>
            <div className="border-t border-surface-rule py-9 lg:border-r lg:border-t-0 lg:px-8 space-y-3">
              <div className="h-4 w-24 rounded bg-rule/40" />
              <div className="h-8 w-36 rounded bg-rule/50" />
            </div>
            <div className="border-t border-surface-rule py-9 lg:border-t-0 lg:pl-8 space-y-4">
          ...
          <div className="grid gap-12 py-12 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
            <div className="space-y-4">
              ...
              <div className="space-y-3 border-t border-surface-rule pt-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center gap-3 border-b border-surface-rule py-3">
            ...
            <div className="space-y-4 border-t border-surface-rule pt-5">
